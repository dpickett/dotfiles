...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="launch"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/dpickett/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/dpickett/.mailcheckrc"
# }
